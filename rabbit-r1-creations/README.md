...
| Image generation (`com.r1.pixelart`) | **Undocumented bridge** for AI image transformation — capture a frame, send with `pluginId: "com.r1.pixelart"` + a style prompt, and the r1 generates a transformed image. Includes 80+ example style prompts from Rabbit's official app. |
